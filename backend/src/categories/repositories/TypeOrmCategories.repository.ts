...
export class TypeOrmCategoryRepository implements ICategoryRepository {
    ...
    async findAll(page: number, limit: number, order: OrderEnum, sortBy?: SortByCategory, name?: string): Promise<PaginatedResult<CategoryEntity>> {
    ...
    private queryBuilder(sortBy?: SortByCategory, name?: string, order: OrderEnum = OrderEnum.ASC){
        const query = this.categoriesRepository.createQueryBuilder('product').leftJoinAndSelect('product.category', 'category');
